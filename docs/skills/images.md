...
- **El botón dice qué pasa, sin orden** (`global §2.3d`: el director de 55 se resiste a la orden): `Lo vemos con tu caso en 30 min` mejor que `Agenda 30 min y lo verás en acción!` (demo genérica, orden y sin `¡`).
