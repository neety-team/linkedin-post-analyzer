...
- **🟣 EL CENTRO Y LAS 5 VENTANAS DE LA LLANTA VAN EN BERENJENA (Iker, 2026-09-16).** Con la plantilla tal cual, el círculo central salía menta y **se leía como un hueco de logo olvidado**, y los discos blancos de los logos interiores se fundían con el fondo. Iker: *"así los logos van a resaltar más… como prácticamente todos los logos son blancos, si lo que tuviesen alrededor fuese morado, se entendería mejor"*. Comparadas las dos versiones (solo el centro, y centro más ventanas), gana la segunda: con solo el centro, las ventanas se siguen viendo como marcos vacíos. **Lo hace `montar-llanta.py` por defecto** (`rellenar_llanta`: rellena las zonas menta cerradas y pequeñas, y deja la zona de los radios en menta). Avisa si no pinta exactamente 6 zonas. `--sin-relleno` vuelve a lo de antes.
